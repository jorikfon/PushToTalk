...
public class TranscriptionHistory: ObservableObject {
    ...
    private init() {
        print("TranscriptionHistory: Инициализация (только в памяти)")
    }
    ...
    public func addTranscription(_ text: String, duration: TimeInterval) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            print("TranscriptionHistory: Добавлена запись в память: \"\(text.prefix(30))...\"")
        }
    }
    ...
    public func deleteEntry(_ entry: TranscriptionEntry) {
        DispatchQueue.main.async { [weak self] in
            ...
            print("TranscriptionHistory: Удалена запись из памяти")
        }
    }
    ...
    public func clearHistory() {
        DispatchQueue.main.async { [weak self] in
            ...
            print("TranscriptionHistory: История очищена (память)")
        }
    }
