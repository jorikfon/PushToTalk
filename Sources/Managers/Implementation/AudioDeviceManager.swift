...
public class AudioDeviceManager: AudioDeviceManagerProtocol, ObservableObject {

    // MARK: - Backwards Compatibility (deprecated)

    /// ⚠️ DEPRECATED: Используйте ServiceContainer.shared.audioDeviceManager
    /// Временная совместимость для существующего кода
    @available(*, deprecated, message: "Use ServiceContainer.shared.audioDeviceManager instead")
    public static var shared: AudioDeviceManager {
        return ServiceContainer.shared.audioDeviceManager as! AudioDeviceManager
    }
